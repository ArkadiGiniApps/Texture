Pod::Spec.new do |spec|
    ...
    spec.subspec 'Wrapper' do |wrapper|
        wrapper.script_phases  = [
        {
            :name => 'Pre-compile',
            :execution_position => :before_compile,
            :script => '${PODS_TARGET_SRCROOT}/scripts/pnd-namespace-compile-pre.sh'
        },
        {
            :name => 'Postcompile',
            :execution_position => :after_compile ,
            :script => '${PODS_TARGET_SRCROOT}/scripts/pnd-namespace-compile-post.sh'
        }
        ]
    ...
    spec.default_subspecs = 'Core', 'PINRemoteImage', 'Video', 'MapKit', 'AssetsLibrary', 'Photos', 'Wrapper'
